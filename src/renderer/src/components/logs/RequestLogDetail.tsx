...
export function RequestLogDetail({ log, onClose }: RequestLogDetailProps) {
  ...
  return (
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-3xl w-[90vw] h-[85vh] max-h-[800px] p-0 flex flex-col overflow-hidden bg-background">
        {/* Header */}
            ...
            <TabsContent value="info" className="mt-0">
              <div className="grid grid-cols-2 gap-3">
                ...
                <InfoItem
                  ...
                  value={log.usage
                    ? `${log.usage.promptTokens} + ${log.usage.completionTokens} = ${log.usage.totalTokens} Token`
                    : '-'}
                />
                <InfoItem 
                  label={t('logs.method')} 
