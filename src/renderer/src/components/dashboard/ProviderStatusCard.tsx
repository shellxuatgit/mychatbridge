            ...
            <div className="space-y-2">
              {providers.map((provider) => {
                ...
                return (
                  <div
                    key={provider.id}
                    className="p-3 rounded-lg bg-muted/30 hover:bg-muted/50  transition-all duration-200"
                  >
                    ...
                    <div className="grid grid-cols-4 gap-2 text-xs">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{provider.totalTokens ? `${formatTokenCount(provider.totalTokens)} Token` : '0 Token'}</p>
                      </div>
                      <div>
