      ...
      <div className="max-w-4xl mx-auto space-y-6 pb-12 px-4 animate-fade-in">
        <div className="flex flex-col items-center justify-center py-10 text-center relative">
          ...
          <div className="relative mb-6 animate-scale-in">
            <div className="relative w-24 h-24 rounded-lg glass-card p-4  border border-[var(--glass-border)] bg-[var(--glass-bg)] overflow-hidden">
              <img
                src={logoIcon}
                alt="MyChatBridge Logo"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative z-10">
            ...
            <div className="flex items-center gap-3">
              {updateInfo.phase === 'checking' ? (
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--success)]/10 ">
